  ...
  <LayoutAppLayout :flush="true">
    ...
    <div class="flex h-full">
      ...
      <div class="flex-1 flex flex-col min-w-0">
        <!-- Sub-header -->
        <div class="h-[44px] border-b border-zinc-200 bg-white flex items-center justify-between px-4 shrink-0">
        ...
        <div ref="messagesContainer" class="flex-1 overflow-y-auto">
          ...
          <template v-else>
            ...
            />
            <AgentChatMessage
              v-if="chat.isStreaming.value && (chat.streamingContent.value || chat.streamingToolCalls.value.length)"
              role="assistant"
              :content="chat.streamingContent.value"
              :tool-calls="chat.streamingToolCalls.value"
              :is-streaming="true"
            />
            <div
